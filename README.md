...
## Real examples (live links)

Every link below was generated by the prompt next to it — click to open the real
AWS estimate. From a one-word-vague idea to a full grouped architecture:

| What you type | Cost | Estimate link |
|---------------|------|---------------|
| *"a small website with a database and a 100GB bucket"* (vague) | ~$146/mo | [open](https://calculator.aws/#/estimate?id=5ee317b0d334ca93f1ef10513235db7d9f74356a) |
| *"cheapest setup: 1 t4g.small server with 20GB for a personal blog"* | ~$14/mo | [open](https://calculator.aws/#/estimate?id=3f54f5ce9c3ec75651285396d365a0084728c360) |
| *"1 t4g.medium server 50GB with daily snapshot, plus a 100GB S3 bucket"* | ~$41/mo | [open](https://calculator.aws/#/estimate?id=d32b3a28e26e4283371cbe9e523438fe023389bb) |
| *"3 t3.large EC2 with 50GB, RDS MySQL db.m5.large 100GB multi-az, 500GB S3, an ALB, CloudFront 1TB"* `--group` | ~$641/mo | [open](https://calculator.aws/#/estimate?id=d7999f4669ad460084f4f50d25e060b3c69e5b92) |
| *"Lambda with 10M requests, DynamoDB, API Gateway, 200GB S3"* `--group` | ~$29/mo | [open](https://calculator.aws/#/estimate?id=00acdb212a110d13966fad01174d091cfd3efd8a) |
| *"4 m5.xlarge EC2, Aurora MySQL db.r6g.large 2 nodes, Redis cache.r6g.large, CloudFront 2TB, WAF, GuardDuty, CloudTrail"* `--group` | ~$961/mo | [open](https://calculator.aws/#/estimate?id=9043a6a1c002074063230ad1345628e474673d7d) |
